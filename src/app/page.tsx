...
const perks = [
  ...
  Icon: CheckCircle,
  description:"Every asset on our platform is verified by our team to ensure the highest quality standards. Not happy? We offer a 30-day refund guarantee.",
},
  {
  name: 'For the planet',
  Icon: Leaf,
  ...
  return (
    <>
      <MaxWidthWrapper>
        ...
        {/*todo: insert products to display*/}
      </MaxWidthWrapper>
      <section className="border-t border-gray-200 bg-gray-50">
        <MaxWidthWrapper className="py-20 ">
          <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-0">
            {perks.map((perks) => (
              <div key={perks.name} className="text-center md:items-start md:flex md:text-left lg:block lg:text-center">
                <div className="md:flex-shrink-0 flex justify-center">
                  <div className="h-16 w-16 flex items-center justify-center rounded-full bg-violet-100 text-violet-900">
                    {<perks.Icon className="w-1/2 h-1/3"/>}
                  </div>
                </div>
                <div className="mt-6 md:ml-4 md:mt-0 lg:ml-0 lg:mt-3">
